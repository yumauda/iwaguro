      ...
      <div class="p-page-mv__content">
        <div class="p-page-mv__detail p-page-mv__detail--figures">
          <ul class="p-page-mv__breadcrumbs p-page-mv__breadcrumbs--interview p-page-mv__breadcrumbs--interviewSp">
            ...
            <li class="p-page-mv__breadcrumbs-list">
              <p class="p-page-mv__breadcrumbs-link">Y.H.</p>
            </li>
          </ul>
    ...
    <div class="l-inner l-single-inner">
      <div class="p-single__content">
        <figure class="p-single__img">
          <picture>
            <source srcset="<?php echo get_template_directory_uri(); ?>/images/interview/yh/single_img_top.jpg" media="(min-width: 768px)" width="1238" height="570" />
      ...
      <div class="p-question__content">
        <div class="p-question__wrap">
          <div class="p-question__block">
            <h4 class="p-question__q">
              ...
              <p class="p-question__title">入社のきっかけは？</p>
            </h4>
            <div class="p-question__answer-wrapper">
              <p class="p-question__answer">飲料メーカーへ工場見学に行った際、ボトリング工程を見て「機械装置をつくる仕事って面白そう」と興味を持ちました。岩黒製作所を知ったのは就職活動中で、医薬品関連の機械設計・製造という仕事内容に惹かれて応募しました。<br>
              <br>
              工学部出身のため、入社後は希望していた設計部で製図を担当しましたが、当時の営業部の上司に「人と話すことが好きなら営業をやってみないか」と声をかけられ、2年目に営業職へ。実際にやってみると思っていた以上に性に合っていて。今となっては「あの時、営業に転向してよかった！」と思っています。</p>
            </div>
          </div>
          <figure class="p-question__img">
            <picture>
              <source srcset="<?php echo get_template_directory_uri(); ?>/images/interview/yh/question_img1.jpg" media="(min-width: 768px)" width="1238" height="570" />
              <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri(); ?>/images/interview/yh/question_img1_sp.jpg" alt="" width="355" height="227">
            </picture>
            <!-- <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri() ?>/images/interview/yh/question_img1.jpg" alt="" width="1100" height="473"> -->
          </figure>
        </div>
        ...
        <div class="p-question__wrap">
          <div class="p-question__block">
            ...
            <div class="p-question__answer-wrapper">
              <p class="p-question__answer">当社の営業は、「セールスエンジニア」です。お客様と一緒に機械の仕様を決め、それを設計部や加工部と連携して完成させます。一年の半分は全国を飛び回り、お客様への技術的なサポートも行っています。すべてオーダーメイドの機械なので毎回が新しい挑戦。それをどうみんなでつくり上げられるか、考え、実現していくのがこの仕事のおもしろさです。</p>
            </div>
          </div>
        </div>
        ...
        <div class="p-question__row-wrapper">
          ...
          <div class="p-question__row">
            <div class="p-question__block">
              <h4 class="p-question__q">
                <span class="p-question__q--en">Q</span>
                <p class="p-question__title">仕事をする上で、心がけていることは？</p>
              </h4>
              <div class="p-question__answer-wrapper">
                <p class="p-question__answer">新規案件は商社経由でご相談いただくことが多いので、社外の人との関係づくりも大事な仕事のひとつ。どんな要望も形にできるよう情報収集や知識のアップデートは欠かせませんし、お客様から「何を聞いても詳しい」「その場で答えてくれる安心感がある」と言っていただけると嬉しいです。</p>
              </div>
            </div>
            <figure class="p-question__rowImg">
              <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri() ?>/images/interview/yh/question_img2.jpg" alt="" width="431" height="380">
            </figure>
          </div>
          <div class="p-question__row ImgLeft">
            <div class="p-question__block">
              <h4 class="p-question__q">
                <span class="p-question__q--en">Q</span>
                <p class="p-question__title">印象に残っている仕事を教えてください。</p>
              </h4>
              <div class="p-question__answer-wrapper">
                <p class="p-question__answer">某製薬会社様との共同開発プロジェクトです。今までにないモノを一緒に創ろうと共に悩み、トライ&エラーを繰り返して5年の歳月を経て完成させました。あの時の達成感と感動は今も忘れられない思い出です。<br>
                <br>
                時代の流れや製薬の多様化に伴い、お客様の要望も年々高度化していて、実現不可能と思える時もあります。でも、難易度が高いほどワクワクしますし、どうやって形にするかを考えている時が、一番おもしろいんです！生みの苦しみもありますが、それを乗り越えた先の充実感を味わうと、この仕事は辞められません。</p>
              </div>
            </div>
            <figure class="p-question__rowImg">
              <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri() ?>/images/interview/yh/question_img3.jpg" alt="" width="431" height="380">
            </figure>
          </div>
        </div>
          ...
          <div class="p-question__who-detail">
            ...
            <div class="p-question__who-titleWrapper">
              ...
              <div class="p-question__white">
                ...
                規模感も大きすぎず小さすぎずちょうど良く社長にも直接話ができるコミュニケーションが取りやすい環境です。「失敗も大事な結果」と捉える社風や高いプロ意識を持った仲間の存在も岩黒の原動力。<span>やる気のある方、興味・好奇心旺盛な方にぴったり</span>の職場だと思います。</p>
              </div>
            </div>
          </div>
