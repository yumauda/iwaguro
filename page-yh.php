      ...
      <div class="p-question__content">
        ...
        <div class="p-question__wrap">
          <div class="p-question__block">
            ...
            <div class="p-question__answer-wrapper">
              <p class="p-question__answer">当社の営業は、「セールスエンジニア」です。お客さまと一緒に機械の仕様を決め、それを設計部や加工部と連携して完成させます。すべてオーダーメイドの機械なので毎回が新しい挑戦。それをどうみんなでつくり上げられるか、考え、実現していくのがこの仕事のおもしろさです。</p>
            </div>
          </div>
        </div>
        ...
        <div class="p-question__row-wrapper">
          ...
          <div class="p-question__row">
            <div class="p-question__block">
              ...
              <div class="p-question__answer-wrapper">
                <p class="p-question__answer">新規案件は商社経由でご相談いただくことが多いので、社外の人との関係づくりも大事な仕事のひとつ。どんな要望も形にできるよう情報収集や知識のアップデートは欠かせませんし、お客さまから「何を聞いても詳しい」「その場で答えてくれる安心感がある」と言っていただけると嬉しいです。</p>
              </div>
            </div>
          ...
          <div class="p-question__row ImgLeft">
            <div class="p-question__block">
              ...
              <div class="p-question__answer-wrapper">
                ...
                <br>
                時代の流れや製薬の多様化に伴い、お客さまの要望も年々高度化していて、実現不可能と思える時もあります。でも、難易度が高いほどワクワクしますし、どうやって形にするかを考えている時が、一番おもしろいんです！生みの苦しみもありますが、それを乗り越えた先の充実感を味わうと、この仕事は辞められません。</p>
              </div>
            </div>
            <figure class="p-question__rowImg">
