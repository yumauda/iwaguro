      ...
      <div class="p-question__content">
        ...
        <div class="p-question__wrap">
          <div class="p-question__block">
            ...
            <div class="p-question__answer-wrapper">
              <p class="p-question__answer">当社の営業は、「セールスエンジニア」です。お客様と一緒に機械の仕様を決め、それを設計部や加工部と連携して完成させます。すべてオーダーメイドの機械なので毎回が新しい挑戦。それをどうみんなでつくり上げられるか、考え、実現していくのがこの仕事のおもしろさです。</p>
            </div>
          </div>
        </div>
