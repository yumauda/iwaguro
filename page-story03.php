        ...
        <div class="p-page-mv__detail p-page-mv__detail--story03">
          ...
          <div class="p-page-mv__text-wrapper">
            <p class="p-page-mv__text">
              当社は、医薬品の包装機械や製剤機械といった、社会に欠かせない製品を手がけ、業界から高い信頼を得ています。私たちが大切にしているのは、常に新しい技術やアイデアに挑み続ける“モノづくりの心”。機械づくりに集中できる、自由で刺激にあふれた職場です。
            </p>
          </div>
        </div>
        ...
        <div class="p-occupation__block">
          ...
          <div class="p-occupation__block-textWrapper">
            <p class="p-occupation__block-text">
              ...
              そんな面白みのあるメーカーで、お客さまのご要望に合わせたオーダーメイドの機械を作ってみたい！そんな方をお待ちしています！
            </p>
          </div>
    ...
    <div class="l-inner">
      <div class="p-other__content">
        <div class="p-other__block">
          ...
          <a href="<?php echo esc_url(home_url('/story02/')); ?>" class="p-other__link p-other__link--second" data-title="OTHER STORIES">
            <figure class="p-other__img">
