        ...
        <div class="p-question__wrap">
          <div class="p-question__block">
            ...
            <div class="p-question__answer-wrapper">
              ...
              営業職ではありませんが、お客様と直接関わったり、他部署と連携して調整を行ったりすることも多い仕事です。経験を積むと 1台の機械を任される担当者になりますが、今はまだ先輩のサポートとして、知識と技術を学んでいます。</p>
            </div>
          </div>
        </div>
        ...
        <div class="p-question__wrap">
          <div class="p-question__block">
            ...
            <div class="p-question__answer-wrapper">
              ...
              <br>
              最もやりがいを感じたのは、主力機械である「PTP自動包装ライン」を納めた時です。この時は登録する薬の品目数が非常に多く、組付けや調整に長い時間がかかりました。さらに、納品後もお客様のところに 3か月間通って調整を行ったため、完了した時の達成感は大きかったですね。</p>
            </div>
          </div>
