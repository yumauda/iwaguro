      ...
      <div class="p-page-mv__content">
        <div class="p-page-mv__detail p-page-mv__detail--figures">
          <ul class="p-page-mv__breadcrumbs p-page-mv__breadcrumbs--interview p-page-mv__breadcrumbs--interviewSp">
            ...
            <li class="p-page-mv__breadcrumbs-list">
              <p class="p-page-mv__breadcrumbs-link">R.N.</p>
            </li>
          </ul>
    ...
    <div class="l-inner l-single-inner">
      <div class="p-single__content">
        <figure class="p-single__img">
          <picture>
            <source srcset="<?php echo get_template_directory_uri(); ?>/images/interview/rn/single_img_top.jpg" media="(min-width: 768px)" width="1238" height="570" />
            <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri(); ?>/images/interview/rn/single_img_top_sp.jpg" alt="" width="355" height="227">
          </picture>
        </figure>
        <div class="p-single__detail">
          <div class="p-single__number">
            <p class="p-single__en">no.</p>
            <p class="p-single__num">05</p>
          </div>
      ...
      <div class="p-question__content">
        <div class="p-question__wrap">
          <div class="p-question__block">
            ...
            <div class="p-question__answer-wrapper">
              ...
              営業職ではありませんが、お客さまと直接関わったり、他部署と連携して調整を行ったりすることも多い仕事です。経験を積むと 1台の機械を任される担当者になりますが、今はまだ先輩のサポートとして、知識と技術を学んでいます。</p>
            </div>
          </div>
        </div>
        ...
        <div class="p-question__wrap">
          <div class="p-question__block">
            <h4 class="p-question__q">
              <span class="p-question__q--en">Q</span>
              <p class="p-question__title">仕事のやりがいやおもしろさを感じる瞬間は？</p>
            </h4>
            <div class="p-question__answer-wrapper">
              <p class="p-question__answer">入社当初は図面を見ても作業内容が理解できませんでしたが、経験を積むうちに「この部品はここに付くだろう」と見当がつくように。作業がスムーズに進められるようになり、モノづくりのおもしろさを感じています。今の目標は、小規模な機械からでいいので、1台を任せてもらえるようになることです。<br>
              <br>
              最もやりがいを感じたのは、主力機械である「PTP自動包装ライン」を納めた時です。この時は登録する薬の品目数が非常に多く、組付けや調整に長い時間がかかりました。さらに、納品後もお客さまのところに 3か月間通って調整を行ったため、完了した時の達成感は大きかったですね。</p>
            </div>
          </div>
          <figure class="p-question__img">
            <picture>
              <source srcset="<?php echo get_template_directory_uri(); ?>/images/interview/rn/question_img1.jpg" media="(min-width: 768px)" width="1238" height="570" />
              <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri(); ?>/images/interview/rn/question_img1_sp.jpg" alt="" width="355" height="227">
            </picture>
            <!-- <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri() ?>/images/interview/rn/question_img1.jpg" alt="" width="1100" height="473"> -->
          </figure>
        </div>
        ...
        <div class="p-question__row-wrapper">
          ...
          <div class="p-question__row">
            <div class="p-question__block">
              <h4 class="p-question__q">
                <span class="p-question__q--en">Q</span>
                <p class="p-question__title">仕事をする上で大切にしていることは？</p>
              </h4>
              <div class="p-question__answer-wrapper">
                <p class="p-question__answer">「分からないことは自分から積極的に聞く」姿勢です。仕事内容はしっかり教えてもらえますが、機械は覚えることが多いので、受け身でいては情報を取りこぼしていまいます。今は先輩とペアで作業していますが、日頃から将来ひとりで機械を任された時のことを想定しながら仕事をしています。</p>
              </div>
            </div>
            <figure class="p-question__rowImg">
              <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri() ?>/images/interview/rn/question_img2.jpg" alt="" width="431" height="380">
            </figure>
          </div>
          <div class="p-question__row ImgLeft">
            <div class="p-question__block">
              <h4 class="p-question__q">
                <span class="p-question__q--en">Q</span>
                <p class="p-question__title">職場の雰囲気や働きやすさはどうですか？</p>
              </h4>
              <div class="p-question__answer-wrapper">
                <p class="p-question__answer">上司にも直接話がしやすい風通しの良い職場だと思います。自分の裁量で仕事のスケジュールが組める自由さもあり、とても働きやすいです。有給休暇も業務に支障がなければ、前日の申請でも取得できるのはありがたいです。<br>
                <br>
                また、最近は部署間で連携しより良いモノづくりや働きやすい職場づくりを目指す動きが進んでいます。例えば、得意な機械だけでなく全員がいろいろな機械に関われるようにしたり、最終検査で他の部署からも広く意見を求めたり。歴史のある会社なので保守的な面もありましたが、会社全体が少しずつ良い方向へ変わってきていると感じています。</p>
              </div>
            </div>
            <figure class="p-question__rowImg">
              <img decoding="async" loading="lazy" src="<?php echo get_template_directory_uri() ?>/images/interview/rn/question_img3.jpg" alt="" width="431" height="380">
            </figure>
          </div>
        </div>
